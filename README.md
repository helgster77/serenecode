...
| **Objects are truly immutable** | `frozen=True` but mutable `set` inside Drug | `_Frozen` mixin + `frozenset` — fully locked down |
...
- **388 functions** verified through Level 5 — zero failures, zero skipped
- **145 contracts** across the codebase (30 invariants, 56 preconditions, 59 postconditions)
- **496 tests** including property-based tests and integration tests
